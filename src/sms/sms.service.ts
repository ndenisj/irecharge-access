...
//     private twilioProvider: TwilioMockProvider,
//     private messageBirdProvider: MessageBirdMockProvider,
//   ) {
//     // Choose provider based on configuration
//     const defaultProvider = this.configService.get('SMS_PROVIDER', 'twilio');
//     this.setProvider(defaultProvider);
//   }
...
//         if (attempt === this.retryAttempts) {
//           throw new Error(`Failed to send SMS after ${this.retryAttempts} attempts`);
//         }
